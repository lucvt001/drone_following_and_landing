...
if __name__ == "__main__":
    image_dir = "/home/lucvt001/drone_ws/src/camera_calibration/images"  # Replace with your directory path
    chessboard_size = (13, 9)  # Number of inner corners per a chessboard row and column
    square_size = 0.020  # Size of a square in your defined unit (e.g., meters)
    output_yaml = "/home/lucvt001/drone_ws/src/camera_calibration/iphone_calibration_coef.yaml"
